...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    skills_nav_installed: 'Installed',
    skills_nav_market: 'Market',
    market_all_categories: 'All',
    skill_tag_api_needed: 'API Key required',
    skill_tag_no_api: 'No API Key',
    market_load_failed: 'Load failed: ',
    market_empty: 'No skills available',
    market_detail_hint: 'This skill is from the Skill Market. Browse the market for more information.',
    market_version: 'Version',
    skills_total_count: 'Total {0}',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    skills_delete: '删除',
    skills_back_to: '返回 {0}',
    skills_nav_installed: '已安装skill',
    skills_nav_market: 'skill广场',
    market_all_categories: '全部',
    skill_tag_api_needed: '需要API Key',
    skill_tag_no_api: '无需API Key',
    market_load_failed: '加载失败：',
    market_empty: '暂无skill',
    market_detail_hint: '此skill来自skill广场，可在广场中查看更多信息。',
    market_version: '版本',
    skills_total_count: '共 {0} 个',
